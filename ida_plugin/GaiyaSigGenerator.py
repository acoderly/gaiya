...
#                                               FUNC_SIG_RAW=self.get_disasm(self.func_start_ea,
#                                                                            self.func_end_ea),
#                                               CODE_SIG_RAW=self.get_disasm(self.code_start_ea,
#                                                                            self.code_end_ea),
...
#                                               CODE_SIG_EA=hex(self.code_start_ea),
#                                               FUNC_SIG=self.get_sig(self.func_start_ea, self.func_end_ea),
#                                               FUNC_SIG_EA=hex(self.func_start_ea),
#                                               END="}",
#                                               EXTRACT_STR="")
